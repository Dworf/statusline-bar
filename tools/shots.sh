...
recipe_hero() {
  ...
  # The config is the script's built-in default, with the colour depth pinned
  # so the render does not depend on the terminal that happens to run this.
